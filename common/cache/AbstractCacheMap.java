 ...
 * 
 * @author wangfeiyang
 * @version $Id: AbstractCacheMap.java, v 0.1 2016年8月3日 下午7:16:04 wangfeiyang Exp $
 */
public abstract class AbstractCacheMap<K,V> implements Cache<K,V> {
    ...
    //读锁可以共享，多个线程可以同时拥有读锁，但是写锁却只能只有一个线程拥有，而且获取写锁的时候，其他线程都已经释放了读锁，而且在该线程获取写锁之后，其他线程不能再获取读锁
